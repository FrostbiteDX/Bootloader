...
enum Results {
	...
	STM32_INIT_ERROR = 1,
    STM32_COMM_ERROR = 2,
    STM32_DISABLE_WRITEPROTECTION_FAILED,
    STM32_GET_BOOTLOADERVERSION_FAILED,
    STM32_ERASE_FAILED,
    STM32_EXTENDED_ERASE_FAILED
};
...
/**  Class implements general BootLoader functionality
  ...
  *
  *	 Intended usage:
  *	 1. Instantiate with provided COMPort-Object
  *	 2. Prepare Flashing
  *	 3. Call Write Memory until Image is finished - Image size is variable
  *	 4. Finish Flashing will start written Image and Close COMPort
  *
