...
//}
//
//size_t Communication::LinuxComPort::sendByte(char data, bool sendInverted) {
//	uint count = 0;
//
...
//}
//
//size_t Communication::LinuxComPort::sendCommand(Communication::Commands Command, bool sendInverted) {
//	return sendByte((char) Command, sendInverted);
//}
//
//
//Communication::LinuxComPort::LinuxComPort(const char* portName) {
